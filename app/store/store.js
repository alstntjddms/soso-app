...
const initialState = {
  ...
  items: {
    ...
    진행중: [
      { seq: 3, title: "타이틀3", content: "테스트 콘텐트 2-1", index: 0 },
      { seq: 4, title: "타이틀4", content: "테스트 콘텐트 2-2", index: 1 },
    ],
    완료: [
      { seq: 5, title: "타이틀5", content: "테스트 콘텐트 3-1", index: 0 },
      { seq: 6, title: "타이틀6", content: "테스트 콘텐트 3-2", index: 1 },
      { seq: 7, title: "타이틀7", content: "테스트 콘텐트 3-3", index: 2 },
    ],
  },
};
